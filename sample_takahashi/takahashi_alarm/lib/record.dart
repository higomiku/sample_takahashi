              ...
              new FlatButton(
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => NextPage(_current.path)));
                },
                child:
                    new Text("SetAlarm", style: TextStyle(color: Colors.white)),
                color: Colors.blueAccent.withOpacity(0.5),
              ),
...
//        io.Directory appDocDirectory = await getApplicationDocumentsDirectory();
  ...
  void onPlayAudio() async {
    ...
    //await audioPlayer.play("/storage/emulated/0/Android/door_chime0.mp3", isLocal: true);
  }

  getRecordFilePath() async {
